		...
		$rspta=$unidadmedida->listar();
 		...
 		while ($reg=$rspta->fetch_object()){
 			$data[]=array(
 				...
 				"2"=>($reg->condicion)?'<button class="btn btn-warning btn-xs" onclick="mostrar('.$reg->idunidad_medida.')"><i class="fas fa-edit"></i></button>'.
 					' <button class="btn btn-danger btn-xs" onclick="desactivar('.$reg->idunidad_medida.')"><i class="fas fa-times-circle"></i></button>':
 					'<button class="btn btn-warning btn-xs" onclick="mostrar('.$reg->idunidad_medida.')"><i class="fas fa-edit"></i></button>'.
