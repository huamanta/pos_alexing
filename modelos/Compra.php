...
require __DIR__ . "/../configuraciones/Conexion.php";
require __DIR__ . "/Helpers.php";
date_default_timezone_set('America/Lima');

class Compra extends Helpers
{
    ...
    public function editar(
        ...
        try {
            ...
            for ($i = 0; $i < count($idproducto); $i++) {
                ...
                if (
                    isset($detallesAnteriores[$idproducto[$i]]) &&
    ...
    public function listar($fecha_inicio, $fecha_fin, $idsucursal)
    {
        ...
        $paginator = (new DBQuery($this->pdo))
            ...
            ->select([
                ...
                "DATE_FORMAT(i.fecha_kardex,'%d/%m/%y | %H:%i:%s %p') AS fecha_kardex",
                'i.idproveedor',
                ...
                'i.num_comprobante',
                'i.total_compra',
                'i.monto_gravado AS gravadas',
                'i.monto_exonerado AS exoneradas',
                'i.monto_igv AS igv',
                'i.impuesto',
                'i.estado',
                'i.imagen',
            ...
            ->join('persona p', 'i.idproveedor = p.idpersona')
            ->join('personal u', 'i.idpersonal = u.idpersonal')
            ->where('i.tipo_c', '=', 'Compra')
