    ...
    <body onload="window.print();">
        ...
        <div class="zona_impresion">
            ...
            <div class="ticket-section" style="text-align:center;">
                <strong>SOLICITUD DE PRODUCTOS</strong><br>
            ...
            <div class="ticket-section">
                <table>
                    <tr>
                        <td><b>Origen:</b></td>
                        <td style="font-size:14px"><?php echo $reg->origen; ?></td>
                    </tr>
                    <tr>
                        <td><b>Destino:</b></td>
                        <td style="font-size:14px"><?php echo $reg->destino; ?></td>
                    </tr>
                    <tr>
                        <td><b>Usuario:</b></td>
                        <td style="font-size:14px"><?php echo $_SESSION["nombre"]; ?></td>
                    </tr>
                    <tr>
                        <td><b>Estado:</b></td>
                        <td style="font-size:14px">
                            <?php
                            echo ($reg->estado == 1) ? "aceptado" : "pendiente";
                            ?>
                        </td>
                    </tr>
                </table>
            ...
            <table class="productos" style="width:100%;">
                ...
                // --- Productos Aceptados ---
                $rsptad->data_seek(0); // Reinicia puntero
                echo "<tr><td colspan='3' style='text-align:center;font-weight:bold;'>PRODUCTOS ACEPTADOS</td></tr>";
                while ($regd = $rsptad->fetch_object()) {
                    if ($regd->estado_detalle == 'aceptado') {
                        echo "<tr>";
                        echo "<td style='font-size:14px'>" . number_format($regd->cantidad_enviada, 0) . "</td>";
                ...
                $rsptad->data_seek(0);
                echo "<tr><td colspan='3' style='text-align:center;font-weight:bold;'>PRODUCTOS RECHAZADOS</td></tr>";
                while ($regd = $rsptad->fetch_object()) {
                    if ($regd->estado_detalle == 'rechazado') {
                        echo "<tr>";
                        echo "<td style='font-size:14px'>" . number_format($regd->cantidad, 0) . "</td>";
                        echo "<td style='text-align:center;font-size:14px'>" . $regd->producto . "</td>";
                        echo "<td style='text-align:right;font-size:14px'>" . $regd->unidad . "</td>";
                        echo "</tr>";
                    }
            ...
            <div class="ticket-section">
                <b>Total de Items Aceptados:</b> <?php echo $totalItems; ?><br>
            </div>


            <div class="nota-final">
                Solicitud generada exitosamente.<br>
