...
//Incluímos la clase Cuentas x Cobrar
require_once "../modelos/CuentasCobrar.php"; 
//Instanaciamos a la clase con el objeto cuentas cobrar
$cuentascobrar = new CuentasCobrar();
//En el objeto $rspta Obtenemos los valores devueltos del método ventacabecera del modelo
$rsptacc = $cuentascobrar->mostrarTicket($_GET["id"]);
//Recorremos todos los valores obtenidos
...
<table border="0" align="center" width="320px">
    ...
    <tr>
      <td colspan="4" align="center">Soritor - Perú</td>
    </tr>
