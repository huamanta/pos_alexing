		...
		<table id="factura_head">
			<tr>
				<td class="logo_factura">
					<div>
						<img src="../files/logos/<?php echo !empty($configuracion['logo']) ? $configuracion['logo'] : 'default.png'; ?>"
							width="80">
					</div>
				</td>
				...
				<td class="info_factura">
					<div class="round" style="text-align: center; border-radius: 10PX;">
						...
						if ($factura['tipo_c'] != 'Compra') {
							...
							<p><strong>
									<h2><?php echo $factura['tipo_comprobante']; ?>
								</strong></h2>
							</p>
		...
		<table id="factura_cliente">
			<tr>
				<td class="info_cliente">
					<div class="round" style="border-radius: 10px;">
						<!-- <span class="h3">Cliente</span> -->
						<table class="datos_cliente">
							<tr>
								<td><label>Razón Social:</label>
									<p><?php echo $factura['proveedor']; ?></p>
								</td>
							...
							<tr>
								<td><label><?php echo $factura['tipo_documento']; ?>:</label>
									<p><?php echo $factura['num_documento']; ?></p>
								</td>
		...
		<table id="factura_detalle" style="width: 100%;">
			<thead>
				<tr>
					...
					<th style="border: 1px solid black;" class="textcenter" width="20px">P.COSTO</th>
			...
			<tbody id="detalle_productos" style="border: 1px solid black;">
				...
				if ($result_detalle > 0) {
					...
					while ($row = mysqli_fetch_assoc($query_productos)) {
						...
						?>
						<tr>
							<td style="border-right: 1px solid black;" class="textcenter" width="20px">
								<?php echo $row['codigo']; ?></td>
							<td style="border-right: 1px solid black;" class="textcenter" width="20px">
								<?php echo round($row['cantidad'], 2); ?></td>
							<td style="border-right: 1px solid black;" class="textcenter" width="20px">
								<?php echo $row['unidadmedida']; ?></td>
							<td style="border-right: 1px solid black; padding-left: 5px;" width="300px">
								<?php echo $row['nombre_producto']; ?></td>
							<td style="border-right: 1px solid black;" class="textcenter" width="20px">
								<?php echo round($row['precio_compra'], 2); ?></td>
							<td style="border-right: 1px solid black;" class="textcenter" width="10px">
								<?php echo round($row['precio_venta'], 2); ?></td>
							<td style="border-right: 1px solid black;" class="textcenter" width="20px">
								<?php echo round($row['subtotal'], 2); ?></td>
						</tr>
						<?php
			...
			<tr>
				<td style="border: 1px solid black;" class="textcenter" colspan="3"><strong>Vendedor :
					</strong><?php echo $factura['personal']; ?></td>
				<td style="border: 1px solid black;" class="textcenter"><strong> SON : </strong>
					<?php echo $con_letra ?></td>
				<td style="border: 1px solid black;" colspan="2" class="textright"><span><strong> OP. GRAVADA
							S/</strong></span></td>
				<td style="border: 1px solid black;" class="textcenter"><span><?php echo $factura['gravada']; ?></span>
				</td>
			</tr>
			<tr>
				<td></td>
				...
				<td></td>
				<td></td>
				<td style="border: 1px solid black;" colspan="2" class="textright"><span><strong> OP. EXONERADA
							S/</strong></span></td>
				<td style="border: 1px solid black;" class="textcenter">
					<span><span><?php echo $factura['exonerada']; ?></span></td>
			</tr>
			<tr>
				<td></td>
				<td></td>
				<td></td>
				<td></td>
				<td style="border: 1px solid black;" colspan="2" class="textright"><span><strong> IGV S/</strong></span>
				</td>
				<td style="border: 1px solid black;" class="textcenter">
					<span><span><?php echo $factura['igv']; ?></span></td>
			</tr>
			<tr>
				<td></td>
				<td></td>
				<td></td>
				<td></td>
				<td style="border: 1px solid black;" colspan="2" class="textright"><span><strong> TOTAL A PAGAR
							S/</strong></span></td>
				<td style="border: 1px solid black;" class="textcenter">
					<span><?php echo $factura['total_compra']; ?></span></td>
			</tr>
			</tfoot>
		</table>
		<div>
