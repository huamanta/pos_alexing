...
<body>
  ...
  <div id="page_pdf">
          ...
          while ($row = mysqli_fetch_assoc($query_productos)) {
            ?>
                <tr>
                    ...
                    <td style="text-align:left; white-space: pre-line;" width="250px">
                        <?php echo nl2br(htmlspecialchars($row['dproducto'])); ?>
                    </td>
    ...
    // IGV SOLO SOBRE OPERACIÓN GRAVADA
    $igv = round($opgrav * ($iva / 100), 2);

    // TOTAL REAL DE LA NOTA DE CRÉDITO
    $total_nc = round($opgrav + $exonerado + $igv, 2);
    ...
    $V = new EnLetras();
    $con_letra = strtoupper($V->ValorEnLetras($total_nc, "CON"));
    ?>
      ...
      <tfoot>
        <tr>
          ...
          <td style="border: 1px solid black; border-left: none; text-align: center; font-size: 12px;">
            <?php echo number_format($total_doc , 2, ".", ""); ?>
          </td>
        </tr>
