<style type="text/css">
    ...
    #detalles {
        ...
        display: block;
        /* Para que el overflow funcione correctamente */
    }
    ...
    .zoom-modulo {
        zoom: 0.85;
        /* Reduce a 85% del tamaño original */
    }
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8" style="margin-top: -15px;">
                                    ...
                                    <div class="card shadow-sm mb-3">
                                        <div class="card-body p-3"
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div>
                                                    <h4 class="mb-0 text-white"><i class="fas fa-shopping-cart"></i>
                                                        Nueva Compra</h4>
                                                </div>
                                        ...
                                        <div class="card-body p-3" id="datosgenerales" hidden>
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mb-2">
                                                    ...
                                                    <select name="tipo_igv" id="tipo_igv"
                                                ...
                                                <div class="col-md-6 mb-2">
                                                    <label class="small font-weight-bold">
                                                        ...
                                                        <a class="ml-2" style="cursor: pointer; font-size: 11px;"
                                                            data-toggle="modal" data-target="#myModalProveedor">
                                                ...
                                                <div class="col-md-3 mb-2">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm"
                                                        name="num_comprobante" id="num_comprobante" maxlength="10"
                                                ...
                                                <table id="detalles" class="table table-sm table-hover mb-0">
                                                    <thead class="thead-light"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th style="width: 12%;" class="text-center">P. Compra
                                                            </th>
                                                            <th style="width: 12%;" class="text-center">P. Venta
                                                            </th>
                                                            <th style="width: 10%;" class="text-center">Subtotal
                                                            </th>
                                                            <th style="width: 8%;" class="text-center">Lote</th>
                                                            <th style="width: 10%;" class="text-center">F. Venc.
                                                            </th>
                                        ...
                                        <div class="card-body p-3">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 text-right">
                                                    ...
                                                    <h5 class="text-info mb-0">S/ <span id="most_exonerado">0.00</span>
                                                    </h5>
                                                    <input type="hidden" name="monto_exonerado" id="monto_exonerado"
                                                        value="0">
                                                </div>
                                                ...
                                                <div class="col-md-3 text-right">
                                                    ...
                                                    <h5 class="text-primary mb-0">S/ <span id="most_gravado">0.00</span>
                                                    </h5>
                                                    <input type="hidden" name="monto_gravado" id="monto_gravado"
                                                        value="0">
                                                </div>
                                                ...
                                                <div class="col-md-3 text-right">
                                                    ...
                                                    <h5 class="text-warning mb-0">S/ <span id="most_imp">0.00</span>
                                                    </h5>
                                                ...
                                                <div class="col-md-3 text-right">
                                                    ...
                                                    <h3 class="text-success mb-0" style="font-size: 2rem;">S/ <span
                                    ...
                                    <div class="card shadow-sm mt-3">
                                        <div class="card-header bg-light p-2">
                                            <h6 class="mb-0"><i class="fas fa-money-bill-wave"></i> Métodos de Pago
                                            </h6>
                                        </div>
                                        <div class="card-body p-3">
                                            <!-- Compra al Crédito -->
                                            <div class="row mb-2">
                                                <div class="col-md-3">
                                                    <label class="small font-weight-bold">¿Compra al
                                                        crédito?</label>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm"
                                                        id="totaldeposito" name="totaldeposito" readonly>
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="small font-weight-bold">Total Efectivo</label>
                                                    <input type="text" class="form-control form-control-sm"
                                                        id="totalrecibido" name="totalrecibido" readonly>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row mt-3 mb-4">
                                        ...
                                        <div class="col-md-6">
                                            <button type="button" class="btn btn-secondary btn-lg btn-block shadow"
                                                id="btnCancelar" onclick="cancelarform()">
                                ...
                                <div class="col-lg-4" style="margin-top: -15px;">
                                    <div class="card shadow-sm" style="position: sticky; top: 20px;">
                                        <div class="card-header p-2"
                                            style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                                            <h6 class="mb-0 text-white"><i class="fas fa-search"></i> Buscar
                                                Productos</h6>
                                        </div>
                                        <div class="card-body p-2">
                                            <div class="row">
                                                <div class="col-md-6 d-flex align-items-center">
                                                    <span class="mr-2">Mostrar</span>
                                                    <select id="limitProductos" class="form-control"
                                                        style="width:100px">
                                                        <option value="10">10</option>
                                                        <option value="25">25</option>
                                                        <option value="50">50</option>
                                                ...
                                                <div class="col-md-12 mt-2">
                                                    <div class="table-responsive">
                                                        <table id="tblarticulos" class="table table-sm table-hover"
                                                            width="100%">
                                                            <thead class="thead-light"
                                                                style="position: sticky; top: 0; z-index: 10;">
                                                                <tr>
...
<div class="modal fade" id="myModalP">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form class="form-horizontal" role="form" name="formularioGuardarImagen" id="formularioGuardarImagen"
                method="POST">
                <div class="modal-header">
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" onclick="limpiarImagen()" class="btn btn-default"
                        data-dismiss="modal">Cerrar</button>
                    <button class="btn btn-primary" type="submit" id="btnGuardar">Guardar</button>
                </div>
            </form>
...
<div class="modal fade" id="myModalProveedor">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="form-horizontal" role="form" name="formularioProveedores" id="formularioProveedores"
                method="POST">
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" onclick="limpiarProveedor()" class="btn btn-default"
                        data-dismiss="modal">Cerrar</button>
                    <button class="btn btn-primary" type="submit" id="btnGuardar">Guardar</button>
                </div>
            </form>
