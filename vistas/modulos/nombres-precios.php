        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <div class="row">
                <?php if ($helpers->getUserPermissionAccion('Crear precio')) { ?>
                <div class="col-md-1">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Crear nombre de precio</h4>
      ...
      <form class="form-horizontal" role="form" name="formulario" id="formulario" method="POST">
        <div class="modal-body">
          <div class="form-group">
            ...
            <div class="col-sm-12">
              <input type="hidden" name="idnombre_p" id="idnombre_p">
...
<script src="vistas/js/nombres-precios.js"></script>