                                ...
                                <div class="row">
                                    <div class="col-md-1">
                                        <button type="button" class="btn btn-outline-primary btn-block btn-xs"
                                            id="btnNuevo" onclick="mostrarform(true)"><i class="fa fa-plus"></i>
                                            Nuevo</button>
                                    </div>
                                </div>
                                                            ...
                                                            <div class="col-md-2 mt-3" hidden>
                                                                ...
                                                                <div class="input-group">
                                                                    <input style="text-align:center" type="text"
                                                                        ...
                                                                        id="porcentaje" maxlength="7"
                                                                        placeholder="Descuento"
                                                                        onkeyup="calcularPorcentaje();"
                                                                        disabled="disabled">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-2 mt-3">
                                                                ...
                                                                <div class="input-group">
                                                                    <input style="text-align:center" type="text"
                                                                        ...
                                                                        name="totalrecibido"
                                                                        placeholder="Monto recibido" readonly>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div id="pagosMixtosContainer">
                                                                    <div class="row mb-2 pagoItem">
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <input type="text"
                                                                                class="form-control nroOperacion"
                                                            ...
                                                            <div class="form-group col-lg-2" style="display: none;"
                                                                ...
                                                                <div class="input-group">
                                                                    <input
                                                                        ...
                                                                        id="inputInteres" name="inputInteres" value="0">
                                                                </div>
                                                    ...
                                                    <div class="card-body" style="margin-top: -35px; overflow-x: auto;">
                                                        <div class="tab-content" id="custom-tabs-one-tabContent">
                                                            ...
                                                            <div style="display: flex; align-items: center; gap: 8px;"
                                                                ...
                                                                <button type="button" class="btn btn-default"
                                                                    id="btn_barcode_search"
                                                                    onclick="activeSearch(2)"><span
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form action="" id="formularioappcaja">
                                                        ...
                                                        <div class="col-md-12 md-1 text-center">
                                                            <button type="submit"
                                                                class="btn btn-success">Aperturar</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                    ...
                    <div class="modal-body" style="background-color: #f8f9fa; border-radius: 10px;">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-6">
                                <label for="name" class="control-label">Almacen <span
    ...
    <div class="modal fade" id="ModalClientes">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form class="form-horizontal" role="form" name="formularioClientes" id="formularioClientes"
                    method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ul class="nav nav-tabs mb-3" id="detalleProductoTabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="tab-imagen-tab" data-toggle="tab" href="#tab-imagen"
                                role="tab" aria-controls="tab-imagen" aria-selected="true">
                                Imagen
                            </a>
                        </li>
                        <li class="nav-item">
