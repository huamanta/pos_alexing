...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Reporte de Ventas por fecha y vendedor</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Reporte de Ventas por fecha y vendedor</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
...
<script src="vistas/js/ventas-vendedor.js"></script>